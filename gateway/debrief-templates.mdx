...
The contract examples on this page work for both:
...
If a debrief should only reach some stakeholders, keep the contract the same and add audience targeting on the outer synced debrief item.
