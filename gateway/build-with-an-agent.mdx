...
If you are still deciding when to wire the gateway, read [Quickstart](/atlas/quickstart) first.

The common rollout is simple:

1. start with Atlas in meetings
2. let your own internal agent publish shared work into Atlas through the [Workspace API](/atlas/workspace-api)
...
If you are reading the hosted docs, use these links directly.

These are plain markdown files you can copy into Claude, Codex, Cursor, or your own internal coding agent workflow:

- [gateway-builder-brief.md](https://raw.githubusercontent.com/abhishekloiwal/docs/main/templates/gateway-builder-brief.md)
- [gateway-manifest-checklist.md](https://raw.githubusercontent.com/abhishekloiwal/docs/main/templates/gateway-manifest-checklist.md)
- [gateway-acceptance-tests.md](https://raw.githubusercontent.com/abhishekloiwal/docs/main/templates/gateway-acceptance-tests.md)

If you want to inspect them in GitHub first:

- [templates/](https://github.com/abhishekloiwal/docs/tree/main/templates)
...
If your internal coding agent starts dumping too many actions into the manifest, reset the scope and ask for a smaller first version.
...
Some teams do not want Atlas to call tools during the meeting at all.

In that case, use the [Workspace API](/atlas/workspace-api) instead:
