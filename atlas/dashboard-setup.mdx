...
If you want the practical rollout first, start with [Quickstart](/atlas/quickstart).

This page is for the teams that already know they want to wire a live gateway.
...
This setting is chosen at meeting start time.

It is a meeting-level runtime choice, not a separate agent type.
